...
- Pruebas: `node --test tests/tabaco-core.test.mjs` (15) y la prueba de pantalla por CDP `humo_tabaco.mjs` del scratchpad (217 comprobaciones, con el Excel real de Jose, las dos ventanas y la manipulación del registro).
